...
namespace WebProduct.Infrastructure.Data.migration
{
    /// <inheritdoc />
    public partial class @in : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Description 1", "Product 1", 100m, "https://" },
                    { 2, 1, "Description 2", "Product 2", 300m, "https://" },
                    { 3, 3, "Description 3", "Product 3", 500m, "https://" },
                    { 4, 2, "Description 4", "Product 4", 900m, "https://" }
                });
